...
家族限定の猫ケア管理 Web アプリ **nyalog** の実装・レビュー・リファクタリング時に参照するセキュリティガイド。`docs/vibe-coding-security.md` と `docs/20260414-152659_Webサービス公開前のチェックリスト.md` から家族限定アプリでも効く観点を抽出し、Hono/React/Drizzle/Cloudflare Workers スタック向けに具体化した 23 ルールをまとめる。
...
- `docs/vibe-coding-security.md` — プロジェクト内の原則集
- `docs/20260414-152659_Webサービス公開前のチェックリスト.md` — プロジェクト内の公開前チェックリスト
